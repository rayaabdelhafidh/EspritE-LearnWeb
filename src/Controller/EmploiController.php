...
class EmploiController extends AbstractController
{
    ...
    #[Route('/EmploisFront', name: 'app_emploi_show_front', methods: ['GET'])]
    public function showEmploisFront(EmploiRepository $emploiRepository, Request $request): Response
    {
        ...
        // Fetch emplois based on selected premierdate
        $emplois = [];
        ...
        return $this->render('emploi/showFront.html.twig', [
            'emplois' => $emplois,
    ...
    public function generatePdf(
        ...
        $html = $this->renderView('emploi/all_emplois_pdf.html.twig', [
            'emplois' => $emplois,
            'premierdate' => $selectedPremierdate, // Pass premierdate to the Twig template
        ]);
